...
public class SecretaryWorkActivity extends Activity implements OnClickListener {
	...
	private static final String HTTPPATH = Url.URLa+"JSONServlet";
	private static final String INSERT= Url.URLa+"InsertServlet";
		...
		public void handleMessage(Message msg) {
			super.handleMessage(msg);
				...
				for(MessageEntity message:messages){
					...
					if(message.getRole().equals("秘书")){
						message.setMsgType(false);
					}else{
						message.setMsgType(true);
					}
				}
				adapter = new MsgViewAdapter(SecretaryWorkActivity.this, messages);
