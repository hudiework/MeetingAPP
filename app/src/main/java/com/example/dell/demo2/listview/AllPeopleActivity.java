...
public class AllPeopleActivity extends Activity implements OnClickListener {
	...
	private static final String HTTPPATH = Url.URLa+"AllPeopleServlet";
	private static final String INSERT= Url.URLa+"InsertPeopleServlet";
		...
		public void handleMessage(Message msg) {
			super.handleMessage(msg);
				...
				for(MessageEntity message:messages){
					...
					if(message.getName().equals(workName)){
						message.setMsgType(false);
					}else{
						message.setMsgType(true);
					}
				}
				adapter = new MsgViewAdapter(AllPeopleActivity.this, messages);
