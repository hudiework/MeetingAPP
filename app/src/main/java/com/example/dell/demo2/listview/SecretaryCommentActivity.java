...
public class SecretaryCommentActivity extends Activity{

	private ListView listView;
	private List<CommentEntity> list;
	private CommentAdapter myAdapter;
	private static final String HTTPPATH = Url.URLa+"SeCommentServlet";
	private String mid;
	...
	Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			myAdapter = new CommentAdapter(SecretaryCommentActivity.this,list);
			...
			listView.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view,
                    ...
                    Intent i=new Intent(SecretaryCommentActivity.this,CommentDetailActivity.class);
