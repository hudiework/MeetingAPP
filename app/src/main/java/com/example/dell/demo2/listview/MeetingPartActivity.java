...
public class MeetingPartActivity extends Activity{
	...
	Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			messageAdapter = new MessageAdapter(MeetingPartActivity.this,list);
			...
			listView.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view,
					...
					Intent intent=new Intent(MeetingPartActivity.this,MyDetailActivity.class);
