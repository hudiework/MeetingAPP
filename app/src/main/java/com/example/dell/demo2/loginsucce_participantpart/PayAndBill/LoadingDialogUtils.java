...
public class LoadingDialogUtils {
     ...
     * @return
     */
    public static Dialog initWaitDialog(Context context, String msg, boolean isTransBg, boolean isCancelable) {
        ...
        // 加载动画
        @SuppressLint("ResourceType") Animation hyperspaceJumpAnimation = AnimationUtils.loadAnimation(context, R.anim.rotate_animation);
        // 使用ImageView显示动画
    ...
    public static void startDialog(Dialog mDialogUtils){
        mDialogUtils.show();
    }
